	...
	return (
		<StyledGridContainer>
			...
			<div className="grid_item">
				Link to todays workout program! <br></br>(calendar, with current workout
				highlighted + previous missed/done workouts)
			</div>
			<div className="grid_item">
				Depending on goal: if muscle growth - You've gained x amount of weight
				since starting!
			</div>
